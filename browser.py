...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_6.setStyleSheet("background-color:rgb(45,45,45);\n""border-radius:7px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "GithubCRCE"))
        ...
        self.label_2.setText(_translate("Form", "Developed by Warren Fernandes"))
